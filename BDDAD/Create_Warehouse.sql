...
CREATE TABLE Local_Recolha_DIM(
    ...
    CONSTRAINT LOCAL_RECOLHA_HUB_ID_FK FOREIGN KEY (Hub_ID) REFERENCES Hub(Location_ID),
    CONSTRAINT LOCAL_RECOLHA_TIPO_HUB_ID_FK FOREIGN KEY (Tipo_Hub_ID) REFERENCES Tipo_Hub(ID)
);
