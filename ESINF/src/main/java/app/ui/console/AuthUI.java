...
public class AuthUI implements Runnable{
    ...
    private List<MenuItem> getMenuItemForRoles()
    {
        ...
        rolesUI.add(new MenuItem(Constants.ROLE_DRIVER, new DriverUI()));
        rolesUI.add(new MenuItem(Constants.ROLE_AGRICULTURAL_MANAGER, new AgricManagerUI()));
        rolesUI.add(new MenuItem(Constants.ROLE_DISTRIBUTION_MANAGER, new DistManagerUI()));
